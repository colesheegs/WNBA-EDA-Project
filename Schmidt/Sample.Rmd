...
## Each Team's Number of Wins And Losses In Close Home vs. Away Games
...
```{r}
# Home vs. Away Outcomes
team_win_vs_losses <- ggplot(win_loss_per_team, aes(x = home_or_away, y = occurences, fill = result)) +
...
## Graph For Number of Shots Taken By Each of The WNBA Teams In Final 30 Seconds of Close Games
...
shots_made_data1 \|\> ggplot(aes(x = fct_rev(fct_infreq(home)), fill =
